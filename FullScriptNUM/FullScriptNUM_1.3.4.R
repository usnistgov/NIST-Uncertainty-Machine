# Version
cat("NIST Validation & Verification R Script Version 1.3.4 \r\n")
...
for (packageName in c("truncnorm","triangle","nleqslv","mvtnorm","numDeriv","parallel"))
{
    cnt = 1
...
if (version =="1.0.2" || version =="1.0.3" || version =="1.0.4" || version =="1.0.5" || version =="1.1" || version =="1.2"|| version =="1.3")
{
	line = readLines(fh, n=1 )
